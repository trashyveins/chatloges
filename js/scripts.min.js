        ...
        for (var t = 0; t < text.length; t++) {
            ...
            for (var i = 0; i < wrappedText.length; i++) {
                ...
                if (cleanLineText.trim().startsWith("*") || cleanLineText.trim().startsWith(">")) {
                    ...
                    $line.addClass("low");
                } else if (lineText.toLowerCase().includes(" susurra (vehículo)")) {
                    resetAllStates();
                ...
                } else if (lineText.toLowerCase().includes(" dice:") || lineText.toLowerCase().includes("dice (a")) {
                    resetAllStates();
                    ...
                    $line.addClass("grey");
                } else if (lineText.toLowerCase().includes("you paid $") || lineText.toLowerCase().includes("te ha dado") || lineText.toLowerCase().includes("you gave") || lineText.toLowerCase().includes("paid you $")) {
                    resetAllStates();
